          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="bg-slate-800/80 text-slate-300 border-b border-slate-700">
                ...
                <th className="p-3">Buyer / Customer Details</th>
        ...
        <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md flex items-center justify-center p-4 z-50">
          <div className="bg-slate-900 border-2 border-amber-500/50 rounded-2xl p-6 max-w-md w-full text-white shadow-2xl space-y-4">
            ...
            <form onSubmit={handleRecordNewSale} className="space-y-3">
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Customer / Buyer Full Name</label>
                <input
                  type="text"
                  required
              ...
              <div>
                <label className="text-xs font-bold text-slate-300 block mb-1">Customer / Buyer Phone</label>
                <input
                  type="tel"
                  required
